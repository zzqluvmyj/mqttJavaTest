...
public class InterMultipleSpindleReceiveTest extends ClientTest{
    ...
    public InterMultipleSpindleReceiveTest(String broker, int threadSize,int topics) {
    ...
    public void startTest() {
        super.startTest();
        for (int i = 0; i < threadSize; i++) {
            threads[i].getPeer().subscribe("topic",topicNOs[i], Qoss);
        }
    ...
    public static void main(String[] args) {
        ...
        int threadSize = 100;
        int topics=100;
        InterMultipleSpindleReceiveTest m=new InterMultipleSpindleReceiveTest(broker,threadSize,topics);
        m.init();
        m.startTest();
    }
}
