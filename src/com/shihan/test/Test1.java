...
public class Test1 {
    public static void main(String[] args) {
        ...
        Map<Integer, Boolean> arrivedNoMap = new HashMap<>();//消息到达的map
        Map<Integer, Boolean> connectedNoMap = new HashMap<>();//客户端连接的map
        Peer peer;//temp
